...
public class vedioadapter4 extends RecyclerView.Adapter<vedioadapter4.VedioViewHolder> {

    List<Youtubevedio4> youtubeVedioList;

    public vedioadapter4() {
    }

    public vedioadapter4(List<Youtubevedio4> youtubeVedioList) {
